...
{
    string foo;
    cout << "Masukkan nilai anak dari " << r->getValue() << " (-1 for stop) : ";
    cin >> foo;
    if (foo == "-1")
        return;
        else {
...
int main(int argc, char** args)
{
    ...
    cin >> r;
    cout << "Memasukkan nilai anak, 1 digit untuk 1 anak dan lebih dari digit utk lebih dari satu node anak..." << endl;
